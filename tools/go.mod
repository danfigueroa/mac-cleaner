// Módulo separado apenas para ferramentas de desenvolvimento.
//
// Ele existe para que as ~200 dependências do golangci-lint não entrem no
// go.mod do módulo principal: quem roda `go install .../cmd/mac-cleaner@latest`
// deve baixar cobra e bubbletea, e nada além disso. A versão do lint fica
// pinada aqui, então CI e máquina local rodam exatamente o mesmo linter.
module github.com/danfigueroa/mac-cleaner/tools
